...
var  
  ...
  rateLimit, // sets whether or not to sync the simulation rate w/ fixedTimeStep
...
public_functions.init = function( params ) {
  ...
  if ( SUPPORT_TRANSFERABLE ) {
    // message id + # of objects to report + chunk size * # of values per object
    worldreport = new Float32Array(2 + REPORT_CHUNKSIZE * WORLDREPORT_ITEMSIZE);

    // message id + # of collisions to report + chunk size * # of values per object
    collisionreport = new Float32Array(2 + REPORT_CHUNKSIZE * COLLISIONREPORT_ITEMSIZE);

    // message id + # of vehicles to report + chunk size * # of values per object
    vehiclereport = new Float32Array(2 + REPORT_CHUNKSIZE * VEHICLEREPORT_ITEMSIZE);

    // message id + # of constraints to report + chunk size * # of values per object
